...
if("TRUE" STREQUAL "TRUE")
  set(urdf_tutorial_SOURCE_PREFIX /home/namrata/projects/catkin_ws/src/urdf_tutorial)
  set(urdf_tutorial_DEVEL_PREFIX /home/namrata/projects/catkin_ws/devel)
  ...
  set(urdf_tutorial_INSTALL_PREFIX /home/namrata/projects/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/urdf_tutorial " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/urdf_tutorial' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/namrata/projects/catkin_ws/src/urdf_tutorial/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT urdf_tutorial_NUM_DUMMY_TARGETS)
      set(urdf_tutorial_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::urdf_tutorial::wrapped-linker-option${urdf_tutorial_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR urdf_tutorial_NUM_DUMMY_TARGETS "${urdf_tutorial_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::urdf_tutorial::wrapped-linker-option${urdf_tutorial_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND urdf_tutorial_LIBRARIES "${interface_target_name}")
